...
\end{equation}
Instead of coupling every pair of real-space points, the operator acts
independently on each reciprocal-space mode. Its application consists of a
fast Fourier transform (FFT), multiplication by \(R(\mathbf k)\), and an
inverse FFT.
